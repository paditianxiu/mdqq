...
package me.padi.nbhook.ui.activity
...
import me.padi.nbhook.BuildConfig
...
class MainActivity : AppViewsActivity() {
    ...
    private val homeComponent by lazy {
        ComponentName(
            packageName, "${BuildConfig.APPLICATION_ID}.Home"
        )
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView {
            LinearLayout(
                ...
                LinearLayout(
                    lparams = LayoutParams(widthMatchParent = true), init = {
                ...
                LinearLayout(lparams = LayoutParams(widthMatchParent = true) {
                    ...
                    LinearLayout(
                        ...
                        LinearLayout(lparams = LayoutParams {
                            bottomMargin = 5.dp
                        }, init = {
                            gravity = Gravity.CENTER or Gravity.START
                        }) {
                            TextView {
                                ...
                                textSize = 13f
                                text = stringResource(
                                    R.string.module_version, BuildConfig.VERSION_NAME
                                )
                            }
                            TextView(
                                lparams = LayoutParams {
                ...
                NestedScrollView(lparams = LayoutParams(matchParent = true) {
                    ...
                    LinearLayout(
                        ...
                        Layout(
                            createPromotionItem(
                                R.string.about_module_extension, R.mipmap.ic_kavaref
                            )
                        )
                    }
                }
    ...
    private fun createPromotionItem(
        @StringRes stringResource: Int, @DrawableRes imageResource: Int
    ...
    private fun hideOrShowLauncherIcon(isShow: Boolean) {
        if (isShow) packageManager?.enableComponent(homeComponent, PackageManager.DONT_KILL_APP)
